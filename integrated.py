...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        for btn in [self.proteinButton, self.glutenFreeButton, self.lowCarbsButton, self.vegetarianButton]:
            ...
            btn.setStyleSheet("QPushButton { padding: 10px; font-size: 12px; } QPushButton:checked { background-color: #4CAF50; color: white; }")
    ...
    def loadRecipes(self):
        ...
        try:
            ...
            # Fallback recipes
            recipes = [
                {"id": 1, "name": "Chicken Fried Rice", "ingredients": ["Chicken Thighs", "Soy Sauce", "Sugar", "Rice", "Vegetables"]},
